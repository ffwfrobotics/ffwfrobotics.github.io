...
JMFTS's API surface, configuration, schemas, and invariants. Built for search and lookup, not for reading start to finish.

!!! warning "Not yet written"
    This page is scaffolding. No content has been authored for it yet.

Replace this stub with real reference material for JMFTS. The
